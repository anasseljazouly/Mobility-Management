...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(39201980391583874376)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39201980686228874376)
,p_plug_template_id=>wwv_flow_api.id(39201980391583874376)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39201980900736874376)
,p_plug_template_id=>wwv_flow_api.id(39201980391583874376)
,p_name=>'Change'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39201981219978874376)
,p_plug_template_id=>wwv_flow_api.id(39201980391583874376)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39201981539877874376)
,p_plug_template_id=>wwv_flow_api.id(39201980391583874376)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39201981831996874376)
,p_plug_template_id=>wwv_flow_api.id(39201980391583874376)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39201982123396874376)
,p_plug_template_id=>wwv_flow_api.id(39201980391583874376)
,p_name=>'Sub Regions'
