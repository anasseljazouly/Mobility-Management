...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(39201992389136874380)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39201992635431874381)
,p_plug_template_id=>wwv_flow_api.id(39201992389136874380)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39201992945876874381)
,p_plug_template_id=>wwv_flow_api.id(39201992389136874380)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39201993252024874381)
,p_plug_template_id=>wwv_flow_api.id(39201992389136874380)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39201993585602874381)
,p_plug_template_id=>wwv_flow_api.id(39201992389136874380)
,p_name=>'Delete'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39201993831932874381)
,p_plug_template_id=>wwv_flow_api.id(39201992389136874380)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39201994165481874381)
,p_plug_template_id=>wwv_flow_api.id(39201992389136874380)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39201994453489874381)
,p_plug_template_id=>wwv_flow_api.id(39201992389136874380)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39201994730373874381)
,p_plug_template_id=>wwv_flow_api.id(39201992389136874380)
,p_name=>'Sub Regions'
