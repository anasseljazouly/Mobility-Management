...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(39202016151744874389)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39202016484898874389)
,p_plug_template_id=>wwv_flow_api.id(39202016151744874389)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39202016708436874389)
,p_plug_template_id=>wwv_flow_api.id(39202016151744874389)
,p_name=>'Tabs'
