...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(39202004143685874385)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39202004439548874385)
,p_plug_template_id=>wwv_flow_api.id(39202004143685874385)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39202004777864874385)
,p_plug_template_id=>wwv_flow_api.id(39202004143685874385)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39202005045298874385)
,p_plug_template_id=>wwv_flow_api.id(39202004143685874385)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39202005347199874385)
,p_plug_template_id=>wwv_flow_api.id(39202004143685874385)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39202005619795874385)
,p_plug_template_id=>wwv_flow_api.id(39202004143685874385)
,p_name=>'Sub Regions'
