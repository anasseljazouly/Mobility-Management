...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(39202023562111874391)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39202023826631874391)
,p_plug_template_id=>wwv_flow_api.id(39202023562111874391)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39202024104331874392)
,p_plug_template_id=>wwv_flow_api.id(39202023562111874391)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39202024449832874392)
,p_plug_template_id=>wwv_flow_api.id(39202023562111874391)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39202024747261874392)
,p_plug_template_id=>wwv_flow_api.id(39202023562111874391)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39202025004610874392)
,p_plug_template_id=>wwv_flow_api.id(39202023562111874391)
