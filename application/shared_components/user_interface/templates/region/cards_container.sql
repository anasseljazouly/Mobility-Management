...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(39201959318800874368)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39201959678275874368)
,p_plug_template_id=>wwv_flow_api.id(39201959318800874368)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39201959975717874368)
,p_plug_template_id=>wwv_flow_api.id(39201959318800874368)
,p_name=>'Sub Regions'
