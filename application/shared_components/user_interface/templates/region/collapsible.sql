...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(39201970850975874372)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39201971144125874372)
,p_plug_template_id=>wwv_flow_api.id(39201970850975874372)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39201971497394874372)
,p_plug_template_id=>wwv_flow_api.id(39201970850975874372)
,p_name=>'Change'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39201971706855874373)
,p_plug_template_id=>wwv_flow_api.id(39201970850975874372)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39201972050532874373)
,p_plug_template_id=>wwv_flow_api.id(39201970850975874372)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39201972380331874373)
,p_plug_template_id=>wwv_flow_api.id(39201970850975874372)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39201972600644874373)
,p_plug_template_id=>wwv_flow_api.id(39201970850975874372)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39201972946663874373)
,p_plug_template_id=>wwv_flow_api.id(39201970850975874372)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39201973244270874373)
,p_plug_template_id=>wwv_flow_api.id(39201970850975874372)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39201973591937874373)
,p_plug_template_id=>wwv_flow_api.id(39201970850975874372)
,p_name=>'Sub Regions'
