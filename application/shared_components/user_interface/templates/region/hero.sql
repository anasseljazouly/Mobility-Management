...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(39201984547805874377)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39201984818563874378)
,p_plug_template_id=>wwv_flow_api.id(39201984547805874377)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39201985114505874378)
,p_plug_template_id=>wwv_flow_api.id(39201984547805874377)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39201985407912874378)
,p_plug_template_id=>wwv_flow_api.id(39201984547805874377)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39201985759336874378)
,p_plug_template_id=>wwv_flow_api.id(39201984547805874377)
,p_name=>'Sub Regions'
