...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(39202002349480874384)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39202002692292874384)
,p_plug_template_id=>wwv_flow_api.id(39202002349480874384)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39202002964763874384)
,p_plug_template_id=>wwv_flow_api.id(39202002349480874384)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39202003271442874384)
,p_plug_template_id=>wwv_flow_api.id(39202002349480874384)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39202003545529874384)
,p_plug_template_id=>wwv_flow_api.id(39202002349480874384)
,p_name=>'Sub Regions'
